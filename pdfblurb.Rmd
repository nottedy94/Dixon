...
```{r shpine}
#| fig.cap = "Close-up of Short pine needles (top), female seed cone (middle), male pollen cone (bottom). Cone photos courtesy of LSU School of Renewable Natural Resources [@peccone].",
#| out.width="50%",
#| fig.align="center",
#| fig.show="hold"
